        ...
        <div class="widget-content nopadding">
            <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select class="form-control" name="categories_id" style="width: 415px;">
                ...
                <div class="control-group">
                    ...
                    <div class="controls{{$errors->has('p_color')?' has-error':''}}">
                        <input class="form-control" type="text" name="p_color" id="p_color" value="{{old('p_color')}}" required="required" style="width: 400px;">
