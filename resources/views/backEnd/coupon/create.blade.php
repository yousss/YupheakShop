                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="input-group">
                                ...
                                <input type="text" name="coupon_code" id="coupon_code" class="form-control" value="{{old('coupon_code')}}" required minlength="5" maxlength="15">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="input-group">
                                ...
                                <input type="number" step="0.1" min="0" name="amount" id="amount" class="form-control" value="{{old('amount')}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="input-group">
                                ...
                                <input required type="datetime-local" name="expiry_date" id="expiry_date" data-date-format="yyyy-mm-dd" class="form-control" placeholder="yyyy-mm-dd">
                            </div>
                        </div>
                    </div>
                    <div class="row">
