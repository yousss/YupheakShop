...
<div id="sidebar"><a href="{{url('/admin')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        <li{{$menu_active==1? ' class=active':''}}><a href="{{url('/admin')}}">
                <i class="icon icon-home"></i>
                <span>Dashboard</span></a>
            </li>

            <li class="submenu {{$menu_active==2 ? ' active':''}}">
                <a href="#">
            ...
            <li class="submenu {{$menu_active==4? ' active':''}}">
            ...
            <li class="submenu {{$menu_active==5 ? ' active':''}}">
                ...
                <ul>
                    <li><a href="{{ route('invoices.create') }}">Add New Invoice</a></li>
                    <li><a href="{{route('invoices.index')}}">List Invoices</a></li>
                </ul>
            </li>
    </ul>
</div>
